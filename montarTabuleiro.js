$(function(){
    ...
    /*INICIO DO FOR PARA INCLUIR AS LINHAS*/
            for (i=0; i<8; i++){
                $("#tabuleiro").append("<div id='linha_"+i.toString()+"' class='linha' >");

    /*INICIO DO FOR PARA INCLUIR AS CASAS*/
                for (j=0; j<8; j++){
...
/*INICIO DA CONDIÇÃO IF PARA COLOCAR A PEDRA PRETA OU BRANCA*/
...
/*INICIO DA CONDIÇÃO IF PARA COLOCAR A PEDRA PRETA OU BRANCA*/
  ...
  /*FIM DO FOR PARA INCLUIR AS CASAS*/
            }
    /*FIM DO FOR PARA INCLUIR AS LINHAS*/
    }

    MontarTabuleiro();

/*INICIO DA FUNÇÃO DO CLIQUE*/
$(".casa").click(function(){

      //$("#blc").text($("#jogador1").val());
    //  $("#bla").text($("#jogador2").val());
                  ...
                  if((dI == 2) && (dJ == 2)){
                      if((peca_anterior.indexOf("branca") >= 0))   {
                          ...
                          if(peca_meio != null){
                              ...
                              //inicio condição se a pontuação do jogador maior igual a 2 então acrescenta a palavra ponto no plural
                              if(pontos_brancas >= 2){
                                ponto = " Pontos";
                              }else{
                                ponto = " Ponto";
                              }
                              //fim condição se a pontuação do jogador maior igual a 2 então acrescenta a palavra ponto no plural

                              $("#info_pontos_brancas").text($("#jogador2").val()+" "+pontos_brancas.toString()+ ponto);
                      ...
                      if((peca_anterior.indexOf("preta") >= 0))    {
                          ...
                          if(peca_meio != null){
                              ...
                              //fim condição se a pontuação do jogador maior igual a 2 então acrescenta a palavra ponto no plural
                              $("#info_pontos_pretas").text($("#jogador1").val()+" "+pontos_pretas.toString()+ ponto);
                              $("#"+casa_anterior).remove("#"+peca_anterior);
                              $("#"+casa_selecionada).append(obj);
                          }
                      }
      ...
      if(pontos_pretas == 12){
          $("#info").html("<h1>"+"O JOGADOR "+$("#jogador1").val()+" GANHOU A PARTIDA"+"</h1>");
      }else if (pontos_brancas == 12) {
        $("#info").html("<h1>"+"O JOGADOR "+$("#jogador2").val()+" GANHOU A PARTIDA"+"</h1>");
      }
